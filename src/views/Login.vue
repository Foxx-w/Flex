    ...
    <main class="login-canvas" role="main" aria-label="Вход">
      <div class="login-layout">
        ...
        <div class="login-form">
          ...
          <label class="login-field"><input placeholder="Почта или Логин" v-model="identifier" /></label>
          <label class="login-field"><input placeholder="Пароль" type="password" v-model="password" /></label>
...
const handleLogin = async () => {
  ...
  if (!identifier.value || !password.value) return alert('Введите логин/почту и пароль')
  ...
  try {
    ...
    if (ok) {
      ...
      if (authStore.userRole === 'SELLER') router.push('/sellerpage')
      else router.push('/')
    } else {
