    ...
    <main class="register-canvas" role="main" aria-label="Регистрация">
      <div class="register-layout">
        ...
        <div class="register-form">
          ...
          <label class="reg-field"><input placeholder="Логин" v-model="username" /></label>
          <label class="reg-field"><input placeholder="Почта" type="email" v-model="email" /></label>
          <label class="reg-field"><input placeholder="Пароль" type="password" v-model="password" /></label>
          <label class="reg-field"><input placeholder="Повторите пароль" type="password" v-model="passwordConfirm" /></label>
          ...
          <div style="color:red; min-height:18px">{{ errorMessage }}</div>

          <button class="reg-submit" :disabled="isLoading" @click="handleRegister">
